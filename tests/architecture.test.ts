...
const ALLOWED_WORKSPACE_DEPENDENCIES: Readonly<Record<string, readonly string[]>> = {
  ...
  "@company/ces-cli": ["@company/ces-adapter-sdk", "@company/ces-agent-provider-sdk", "@company/ces-approved-project-model", "@company/ces-atlas-coverage", "@company/ces-atlas-extraction", "@company/ces-atlas-intent-graph", "@company/ces-atlas-quality-evidence", "@company/ces-atlas-review", "@company/ces-document-ingestion", "@company/ces-greenfield-contracts", "@company/ces-implementation-compiler", "@company/ces-laravel-adapter", "@company/ces-pdf-ingestion", "@company/ces-policy-engine", "@company/ces-policy-manifest", "@company/ces-project-schema", "@company/ces-requirement-collection-schema", "@company/ces-requirement-schema", "@company/ces-semantic-record-schema", "@company/ces-test-fixture-adapter", "@company/ces-verification-engine"],
};
