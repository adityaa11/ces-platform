...
const ALLOWED_WORKSPACE_DEPENDENCIES: Readonly<Record<string, readonly string[]>> = {
  ...
  "@company/ces-proposed-project-model": ["@company/ces-atlas-coverage", "@company/ces-atlas-role-contracts", "@company/ces-semantic-record-schema"],
  "@company/ces-semantic-record-schema": [],
  "@company/ces-agent-provider-sdk": ["@company/ces-greenfield-contracts"],
  "@company/ces-approved-project-model": ["@company/ces-atlas-coverage", "@company/ces-atlas-intent-graph", "@company/ces-atlas-review", "@company/ces-proposed-project-model", "@company/ces-semantic-record-schema"],
  ...
  "@company/ces-atlas-role-contracts": [],
  ...
  "@company/ces-atlas-semantic-facts": ["@company/ces-atlas-knowledge-contracts", "@company/ces-source-unit-schema"],
  "@company/ces-atlas-graph-selection": ["@company/ces-atlas-semantic-facts"],
  "@company/ces-atlas-knowledge-assembly": ["@company/ces-atlas-graph-selection", "@company/ces-atlas-knowledge-contracts", "@company/ces-atlas-semantic-facts"],
  "@company/ces-atlas-knowledge-review": ["@company/ces-atlas-knowledge-contracts"],
  ...
  "@company/ces-agents-bridge": ["@company/ces-agent-provider-sdk", "@company/ces-atlas-role-contracts", "@company/ces-atlas-semantic-facts", "@company/ces-greenfield-contracts"],
  "@company/ces-atlas-workflow-ui": ["@company/ces-approved-project-model", "@company/ces-atlas-intent-graph", "@company/ces-atlas-knowledge-contracts", "@company/ces-atlas-model-review-contracts", "@company/ces-atlas-review", "@company/ces-proposed-project-model"],
  "@company/ces-cli": ["@company/ces-adapter-sdk", "@company/ces-agent-provider-sdk", "@company/ces-approved-project-model", "@company/ces-atlas-coverage", "@company/ces-atlas-extraction", "@company/ces-atlas-graph-selection", "@company/ces-atlas-intent-graph", "@company/ces-atlas-knowledge-assembly", "@company/ces-atlas-quality-evidence", "@company/ces-atlas-review", "@company/ces-atlas-semantic-facts", "@company/ces-document-ingestion", "@company/ces-greenfield-contracts", "@company/ces-implementation-compiler", "@company/ces-laravel-adapter", "@company/ces-pdf-ingestion", "@company/ces-policy-engine", "@company/ces-policy-manifest", "@company/ces-project-schema", "@company/ces-requirement-collection-schema", "@company/ces-requirement-schema", "@company/ces-semantic-record-schema", "@company/ces-test-fixture-adapter", "@company/ces-verification-engine"],
};
