...
const ALLOWED_WORKSPACE_DEPENDENCIES: Readonly<Record<string, readonly string[]>> = {
  ...
  "@company/ces-agents-bridge": ["@company/ces-atlas-semantic-facts", "@company/ces-policy-canonical-vocabulary", "@company/ces-policy-knowledge-orchestration", "@company/ces-policy-knowledge-proposals", "@company/ces-policy-knowledge-validation", "@company/ces-policy-source-glossary", "@company/ces-policy-source-vocabulary", "@company/ces-policy-taxonomy"],
