...
REDESIGN-010 plus scoped REDESIGN-010A sequence are active authority. The
REDESIGN-010A amendment closed `ATLAS-REDESIGN-R2-REGRESSION-01` with terminal
outcome `ACCEPTED` after remediation `baaee33` and record `0aa1bc7`.
REDESIGN-000 acceptance authorizes the
