...
- **State:** `in_progress` — `PCC-001` / `PCC-BATCH-01` and `PCC-002` / `PCC-BATCH-02` are approved; `PCC-003` requires its recorded same-origin/CSRF planning decision before implementation.
