...
- **State:** `approved` — SUS-001 through SUS-005 are approved and frozen; the sign-up ticket set is complete.
...
| 5 | [SUS-005](SUS-005-sign-up-guidance-and-error-states.md) / `SUS-BATCH-05` | `approved` | SUS-004 `PASS` | Does the sign-up form explain required inputs and accepted password length clearly while turning safe validation/auth failures into actionable accessible notifications? |
