...
| 7 | [BSS-007](BSS-007-document-store-foundation.md) / BSS-BATCH-07 | `awaiting_review` | BSS-001 | Can immutable source bytes be stored and retrieved through a storage-neutral interface using the initial local adapter? |
