...
| 5 | [BSS-005](BSS-005-agents-bridge-service-foundation.md) / BSS-BATCH-05 | `awaiting_review` | BSS-001, BSS-003 | Can Agents Bridge serve a provider-neutral interactive API and SSE while remaining separate from Atlas truth? |
