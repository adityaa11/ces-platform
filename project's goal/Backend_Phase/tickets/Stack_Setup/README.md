...
| 2 | [BSS-002](BSS-002-local-postgresql-compose.md) / BSS-BATCH-02 | `in_progress` | BSS-001 | Can developers start a durable local PostgreSQL instance through the documented Compose workflow? |
