...
- **State:** `awaiting_review` — SOUT-001 / SOUT-BATCH-01 and SOUT-002 / SOUT-BATCH-02 are approved; SOUT-003 / SOUT-BATCH-03 is awaiting review; SOUT-004 remains planned.
...
| 3 | [SOUT-003](SOUT-003-application-sign-out-validation.md) / `SOUT-BATCH-03` | `awaiting_review` | SOUT-001 and SOUT-002 `PASS` | Does the browser-facing flow invalidate the current Better Auth session, preserve the account, and protect `/home` after sign-out? |
