...
- **State:** `planned` — SOUT-001 through SOUT-004 are drafted; no implementation batch is authorized yet.
...
|---:|---|---|---|---|
| 1 | [SOUT-001](SOUT-001-sign-out-submission-seam.md) / `SOUT-BATCH-01` | `planned` | BSS-004 approved; SUS and SIN sets approved/frozen | Does the browser-facing sign-out seam call the approved endpoint once, navigate only on success, and remain safely retryable on failure? |
