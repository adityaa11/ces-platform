...
- **State:** `awaiting_review` — SOUT-001 / SOUT-BATCH-01 is approved; SOUT-002 / SOUT-BATCH-02 is implemented and awaiting review; SOUT-003 through SOUT-004 remain planned.
...
| 2 | [SOUT-002](SOUT-002-production-account-menu-wiring.md) / `SOUT-BATCH-02` | `awaiting_review` | SOUT-001 `PASS` | Does the production account menu expose a real responsive `Sign out` button while `/demo` retains its explicit fixture behavior? |
