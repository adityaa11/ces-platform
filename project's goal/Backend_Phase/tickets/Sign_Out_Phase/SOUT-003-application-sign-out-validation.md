...
- **Implementation checkpoint:** `d81ae7b` (`test(auth): validate application sign-out lifecycle`)
- **Remediation checkpoint:** `eaf2f15` — F-001 serializes the package test runner so its Vinext lifecycle servers cannot overlap.
