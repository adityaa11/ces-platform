...
| 2 | [SIN-002](SIN-002-production-identity-and-project-library-boundary.md) / `SIN-BATCH-02` | `awaiting_review` | SIN-001 `PASS` | Does the shared shell distinguish authenticated identity from project membership and keep fixture project data/mutations behind an explicit fixture mode? |
