...
## Multimodal extraction direction

The extraction boundary should explicitly support both textual and visual evidence.

A Mistral-backed path can be:
...
The provider integration should sit behind the existing provider-neutral reasoning runtime.
