...
interface AgentDefinition<TInput, TIntermediate, TOutput> {
  readonly id: string;
...
Only `structured-generation` must execute in the first release. Registrations
using unsupported modes must fail during startup.
