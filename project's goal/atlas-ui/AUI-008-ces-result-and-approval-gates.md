...
- Lead each CES result with its exact approved Atlas fact and source PRD revision, then link the grounding back to that fact.
...
- Every CES card visibly identifies its approved fact statement and the linked PRD revision that grounds the result.
