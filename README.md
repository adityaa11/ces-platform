...
| Atlas CLI artifact pipeline | ATLAS-005 implemented locally; hosted and real-provider validation pending | [`apps/cli`](apps/cli/), [Atlas CLI guide](docs/atlas-cli.md) |
