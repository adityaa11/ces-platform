...
export function RuntimeFixtureRoute({ scenario, scenarioId, projectId, workspaceId, view, prd, lens, workflowId, factId, cesItemId }: Props) {
  ...
  const workspaceRoute = route.workspace ? resolveFixtureWorkspaceRoute(projectId, workspaceId, records) : undefined;
  ...
  if (view === "workflow") return <WorkflowWorkspace {...common} initialWorkflowId={workflowId} />;
