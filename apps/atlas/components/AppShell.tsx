...
type Props = { user: User; children: ReactNode; projects: ProjectFixture[]; selectedProjectId?: string; workspace?: ProjectWorkspaceFixture; active?: Destination; projectNavigation?: boolean; sidebarAction?: ReactNode; topbarAction?: ReactNode; contentClassName?: string; routeContext?: { scenario?: string; prd?: string; lens?: "isolate" } };
...
export function AppShell({ user, children, projects, selectedProjectId, active = "projects", projectNavigation = false, sidebarAction, topbarAction, contentClassName = "", routeContext }: Props) {
  ...
  const projectHref = (projectId: string) => demoHref({ projectId, view: "workflow" });
