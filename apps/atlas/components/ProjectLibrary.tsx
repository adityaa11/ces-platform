...
export function ProjectLibrary({ mode, user, projectRole, projects, workspace, scenario }: { mode: ProjectLibraryMode; user: AuthenticatedUser; projectRole?: ProjectRole; projects: ProjectFixture[]; workspace?: ProjectWorkspaceFixture; scenario?: string }) {
  ...
  return <AppShell contentClassName="project-library-content" homeHref={mode === "production" ? "/home" : "/demo"} projectNavigation={Boolean(workspace)} projectRole={projectRole} projects={libraryProjects} signOutMode={mode === "production" ? "session" : "fixture-link"} user={user} workspace={workspace}>
