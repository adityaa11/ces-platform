...
const request = { version: "v1", executionId: "exec-1", artifact: { id: "artifact-1", mimeType: "application/pdf", byteSize: 42, sourceSha256: "a".repeat(64) }, source: { grant: "opaque-grant" }, perception: { capability: "atlas.document.perceive", contractVersion: "v1" } };
