...
test("perception request is bounded, opaque, and path-free", () => {
  const request = { version: "v1", executionId: "exec-1", artifact: { id: "artifact-1", mimeType: "application/pdf", byteSize: 42, sourceSha256: hash }, source: { grant: "opaque-grant" }, perception: { capability: "atlas.document.perceive", contractVersion: "v1" } };
